...
cont.matrix <- makeContrasts (D12vsM12 = ((DOHV12a+DOHV12b)-(Mock12a+Mock12b))-((Mock12a-Mock12b)),
                              D24vsM24 = ((DOHV24a+DOHV24b)-(Mock24a+Mock24b))-((Mock24a-Mock24b)),
                              D48vsM48 = ((DOHV48a+DOHV48b)-(Mock48a+Mock48b))-((Mock48a-Mock48b)),
                              S12vsM12 = ((SarsCoV12a+SarsCoV12b)-(Mock12a+Mock12b))-((Mock12a-Mock12b)),
                              S24vsM24 = ((SarsCoV24a+SarsCoV24b)-(Mock24a+Mock24b))-((Mock24a-Mock24b)),
                              S48vsM48 = ((SarsCoV48a+SarsCoV48b)-(Mock48a+Mock48b))-((Mock48a-Mock48b)),
                              levels=designMat)
print(cont.matrix)
...
topTab_D12vsM12 <- topTable (fit.main, number=nrow(fit.main), coef="D12vsM12", adjust="fdr") 
head(topTab_D12vsM12)
...
```{r annotateTopTables}
topAnnotated_D12vsM12 <- annotatedTopTable(topTab_D12vsM12,
anotPackage="hgu133plus2.db")

write.csv(topAnnotated_D12vsM12, file="./results/topAnnotated_D12vsM12.csv")

```


```{r annotatedTop, echo=FALSE}
short <- head(topAnnotated_D12vsM12[1:5,1:4])
knitr::kable(
  short, booktabs = TRUE,
  caption = 'Annotations added to results "topTable" for the comparison "D12vsM12"'
)
```
```{r}
for (i in 1:6) {
...
title("Genes in common between the three comparisons\n Genes selected with FDR < 0.05 and logFC > 1.5")
```
