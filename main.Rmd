...
cont.matrix <- makeContrasts (M12avsM12b = Mock12a - Mock12b,
                              M24avsM24b = Mock24a - Mock24b,
                              M48avsM48b = Mock48a - Mock48b,
                              D12vsM12 = (DOHV12a+DOHV12b)-(Mock12a+Mock12b),
                              levels=designMat)
print(cont.matrix)
...
topTab_M12avsM12b <- topTable (fit.main, number=nrow(fit.main), coef="M12avsM12b", adjust="fdr") 
head(topTab_M12avsM12b)
