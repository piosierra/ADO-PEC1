...
Differential gene expression (DGE) analysis on SARS-CoV infected 2B4 cells at 12-, 24-, and 48-hrs post infection. We try to reproduce the results of a study [@yoshikawa_dynamic_2010] employed a cDNA microarray to analyze the patterns of the global gene expression of 2B4 cells in response to SARS-CoV, as the first step to explore the likely antiviral signaling pathway/s.
...
cont.matrix <- makeContrasts (
  S12vsM12 =  ((SarsCoV12a+SarsCoV12b) - (Mock12a + Mock12b))- 1.5*(Mock12a - Mock12b),
  S24vsM24 =  ((SarsCoV24a+SarsCoV24b) - (Mock24a + Mock24b))- 1.5*(Mock24a - Mock24b),
  S48vsM48 =  ((SarsCoV48a+SarsCoV48b) - (Mock48a + Mock48b))- 1.5*(Mock48a - Mock48b),
  levels = designMat
)
print(cont.matrix
)
```
```{r}
cont.names <- c("S12vsM12", "S24vsM24", "S48vsM48")
