...
We try to reproduce the microarray analysis of the study **[@yoshikawa_dynamic_2010]**. They employed a cDNA microarray to analyze the patterns of the global gene expression of 2B4 cells in response to SARS-CoV, as the first step to explore the likely antiviral signaling pathway/s.
...
** 1 - Identify the groups and match groups to files.  
...
![Raw data quality control](images/raw_report.png)



## Normalized data quality control
![Normalized data quality control](images/nom_report.png){#id .class width=50% height=50%}
