...
And now we examine the intensity distribution on the arrays chcking the boxplots.  
...
The most interesting is with `browseKEGG` to be able to whatch the relevant overexpressed genes in a certain pathway. 
...
![Bar plot of DGN Enriched data for D24vsM24](figures/enrichDGND24vsM24.png)
![Bar plot of DGN Enriched data for D48vsM48](figures/enrichDGND48vsM48.png)
![Bar plot of DGN Enriched data for S12vsM24](figures/enrichDGNS12vsM12.png)
![Bar plot of DGN Enriched data for S24vsM24](figures/enrichDGNS24vsM24.png)
![Bar plot of DGN Enriched data for S48vsM24](figures/enrichDGNS48vsM48.png)
